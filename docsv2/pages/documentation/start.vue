<template>
    <div>
        ...
        <CodeView
            :code="fontAwesome5"
            title="Font Awesome 5 CDN"
            expanded/>
        <div class="content">
            <blockquote>
                <p>Refer to its documentation for latest release / CDN.</p>
                <p>
                    Please note that Buefy doesn't include icon packs. You have to import it as you
                    prefer (NPM, CDN, etc.).
                </p>
                <p>
        ...
        <div class="media">
            ...
            <div class="media-content">
                ...
                <b-message type="is-success">
                    <div class="content">
                        Even though this is gonna import <strong>ALL</strong> components to your
                        application, Buefy full bundle is optimized and still pretty small:
                        <ul>
                            <li>
                                <strong>script</strong> is <strong>32KB</strong> min+gzip
                            </li>
                            <li>
                                <strong>style</strong> is <strong>28KB</strong>
                                min+gzip (with bulma included)
                            </li>
                        </ul>
                    </div>
                </b-message>
                <CodeView
                    :code="importingBundle | pre"
                    title="Full bundle (recommended)"
                    lang="javascript"
                    expanded/>
                ...
                <b-message type="is-danger">
                    <div class="content">
                        <p>
                            If you only need a couple of Buefy's components, might be a good idea to
                            include individuals.
                        </p>
                        <p>
                            Bear in mind that every individual component has everything they need to
                            work by themselves — including <strong>too many</strong> components
                            individually will <strong>INCREASE</strong> your project's build size,
                            adding the full bundle is recomended in that case.
                        </p>
                        <p>
                            In general, <strong>don't go over 3 components</strong> here. If you
                            want more than that, add the full bundle.
                        </p>
                    </div>
                </b-message>
                ...
                <CodeView
                    :code="importingComponentsAsVuePlugins | pre"
                    title="Individual components as Vue plugins"
                    lang="javascript"
                    expanded/>
                <CodeView
                    :code="importingComponents | pre"
